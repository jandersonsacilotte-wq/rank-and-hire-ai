      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mx-auto grid max-w-3xl grid-cols-1 gap-4 sm:grid-cols-2 mb-12">
          {problems.map((item, i) => (
            ...
            >
              ...
              <p className="text-base font-medium leading-snug text-foreground">{item.text}</p>
            </motion.div>
          ))}
        </div>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <span className="text-base font-medium text-muted-foreground">E não é exagero.</span>
            <div className="h-px flex-1 bg-border" />
          </div>
